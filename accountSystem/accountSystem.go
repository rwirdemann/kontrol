...
var SKR03_kalkKosten = account.AccountDescription{Id: "SKR03_Kostenkalk", Name: "4.1 kalkulatorische Kosten", Type: account.KontenartAufwand}
...
func (r *DefaultAccountSystem) GetSKR03(SKR03konto string, rownr int) *account.Account {
	...
	case IsInRange(SKR03konto, 1755, 1756),
		IsInRange(SKR03konto, 4100, 4140):
	...
	case SKR03konto == "2890", SKR03konto == "2893":
		account = r.accounts[SKR03_kalkKosten.Id]
	case IsInRange(SKR03konto, 2000, 2199),
		...
		IsInRange(SKR03konto, 4893, 4893),
		IsInRange(SKR03konto, 4900, 4999),
