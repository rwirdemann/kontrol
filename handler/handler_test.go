...
func TestGetAccountFilterByCostcenter(t *testing.T) {
	...
	assert.Equal(t, http.StatusOK, rr.Code)
	expected := "{\"Description\":{\"Id\":\"K\",\"Name\":\"k: Kommitment\",\"Type\":\"company\"},\"Bookings\":[{\"RowNr\":13,\"Type\":\"AR\",\"Soll\":\"800\",\"Haben\":\"1337\",\"CostCenter\":\"BW\",\"Project\":\"Project-X\",\"Amount\":2000,\"Text\":\"Rechnung WLW\",\"Year\":2018,\"Month\":1,\"FileCreated\":\"0001-01-01T00:00:00Z\",\"BankCreated\":\"0001-01-01T00:00:00Z\"}],\"KommitmenschNettoFaktura\":0,\"AnteilAusFaktura\":0,\"AnteilAusFairshares\":0,\"KommitmenschDarlehen\":0,\"Costs\":0,\"Advances\":0,\"Reserves\":0,\"Rest\":2000,\"Revenue\":0,\"Taxes\":0,\"Internals\":0,\"Saldo\":2000}"
	assert.Equal(t, expected, rr.Body.String())
}
